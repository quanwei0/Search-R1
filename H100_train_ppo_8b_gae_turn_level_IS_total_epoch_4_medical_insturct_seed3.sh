...
export EXPERIMENT_NAME=Medical-H100-search-r1-SPPO-meta-llama-3-8b-it-em-gae-turn-IS-total-epoch-4-Minibatch256-saved-checkpoint-seed3-lr-warmup-600-valid-search-penalty-0.1-final-answer-penalty-0.3-max-response-length-500-no-varnacne-reduction

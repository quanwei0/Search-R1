...
export EXPERIMENT_NAME=H200-search-r1-ppo-qwen2.5-7b-em-gae-turn-IS-total-epoch-4-Minibatch128-saved-checkpoint-seed6-continue
...
PYTHONUNBUFFERED=1 python3 -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.model.path=/mnt/data1/li003968/verl_checkpoints/H200-search-r1-ppo-qwen2.5-7b-em-gae-turn-IS-total-epoch-4-Minibatch128-saved-checkpoint-seed5/actor/global_step_325 \
    actor_rollout_ref.actor.optim.lr=1e-6 \
    actor_rollout_ref.model.enable_gradient_checkpointing=True \
    actor_rollout_ref.model.use_remove_padding=True \
    actor_rollout_ref.actor.optim.lr_warmup_steps_ratio=0.100 \
    ...
    critic.model.path=/mnt/data1/li003968/verl_checkpoints/H200-search-r1-ppo-qwen2.5-7b-em-gae-turn-IS-total-epoch-4-Minibatch128-saved-checkpoint-seed5/critic/global_step_325 \

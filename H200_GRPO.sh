...
export EXPERIMENT_NAME=${data_name}-search-r1-grpo-qwen2.5-7b-em-variance-reduction
...
PYTHONUNBUFFERED=1 python3 -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.actor.optim.lr_warmup_steps_ratio=0.60 \

...
PYTHONUNBUFFERED=1 python3 -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.model.path=/mnt/data1/li003968/verl_checkpoints/Medical-H200-search-r1-STPPO-meta-llama-3-8b-it-em-total-epoch-4-adaptive-prompt-lr-warmup-0.600-mini-batch-128-micro-batch-32/actor/global_step_75 \
    ...
    critic.model.path=/mnt/data1/li003968/verl_checkpoints/Medical-H200-search-r1-STPPO-meta-llama-3-8b-it-em-total-epoch-4-adaptive-prompt-lr-warmup-0.600-mini-batch-128-micro-batch-32/critic/global_step_75 \

...
export EXPERIMENT_NAME=Medical-H200-search-r1-ppo-qwen2.5-7b-it-em-total-epoch-4-adaptive-prompt-lr-warmup-0.600-mini-batch-128-micro-batch-32-continue

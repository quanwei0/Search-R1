...
export EXPERIMENT_NAME=Medical-H200-search-r1-ppo-meta-llama-3-8b-total-epoch-4-adaptive-prompt-lr-warmup-0.600-mini-batch-128-micro-batch-32-continue
...
PYTHONUNBUFFERED=1 python3 -m verl.trainer.main_ppo \
    ...
    +algorithm.use_mixed_outcome_reward_with_search_penalty=True \
    actor_rollout_ref.model.path=/mnt/data1/li003968/verl_checkpoints/Medical-H200-search-r1-ppo-meta-llama-3-8b-total-epoch-2-adaptive-prompt-lr-warmup-0.600-mini-batch-128-micro-batch-32/actor/global_step_100 \
    ...
    critic.model.path=/mnt/data1/li003968/verl_checkpoints/Medical-H200-search-r1-ppo-meta-llama-3-8b-total-epoch-2-adaptive-prompt-lr-warmup-0.600-mini-batch-128-micro-batch-32/critic/global_step_100 \

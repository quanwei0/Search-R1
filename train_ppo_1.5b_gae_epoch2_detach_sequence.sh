...
export EXPERIMENT_NAME=nq-search-r1-ppo-qwen2.5-1.5b-em-gae-2epochs-detach-hard-sequence
...
echo "Starting experiment with sequence-level importance sampling and hard detach ratio..."

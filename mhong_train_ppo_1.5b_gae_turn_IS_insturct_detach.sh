...
export BASE_MODEL="/code/hongpaul-sandbox/temp/Search-R1/qwen_models/qwen2.5-1.5b-instruct"
export EXPERIMENT_NAME=mhong-nq-search-r1-ppo-qwen2.5-1.5b-em-gae-turn-IS-seed1-instruct-detach

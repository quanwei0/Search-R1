...
export EXPERIMENT_NAME=nq-search-r1-ppo-qwen2.5-1.5b-em-gae-2epochs-detach-hard
...
export BASE_MODEL='Qwen/Qwen2.5-1.5B'
export EXPERIMENT_NAME=nq-search-r1-ppo-qwen2.5-1.5b-em-gae-2epochs-detach-soft
